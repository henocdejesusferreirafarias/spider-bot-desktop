...
export interface PixKeyRegistrationControlResult {
  ...
  profileId: string;
  profileName: string;
  status: "needs_withdrawal_password" | "withdrawal_password_filled" | "withdrawal_ready" | "pix_receiving_ready" | "failed";
  step?: "profile" | "withdrawal-management" | "withdrawal-password" | "withdrawal-password-confirmation" | "pix-receiving-account";
}
