...
O perfil WG do Speed Time usava um padrão provisório e não reconhecia o launcher observado em produção: `https://pwmercjm.wgnetworking.com/clientv3/index.html`. O jogo analisado expõe Cocos 3.8.3, `cc.Director` e um canvas.
...
WG é reconhecido somente em subdomínios de `wgnetworking.com` no caminho `/clientv3/index.html` e recebe a estratégia `cocos-director-tick`.
