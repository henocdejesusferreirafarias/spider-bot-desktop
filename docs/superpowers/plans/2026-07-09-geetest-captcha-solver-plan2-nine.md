...
- [ ] **Step 2: Escrever o harness** `scripts/captcha-gate2-nine.mjs` (captura o captcha_id do demo nine dinamicamente — **não** hardcode o do slide):
```js
import { chromium } from 'patchright';
...
const DEMO = 'https://gt4.geetest.com/demov4/nine-popup-en.html';
const browser = await chromium.launch({ headless: true });
// captura o captcha_id do demo nine (nao eh o do slide)
